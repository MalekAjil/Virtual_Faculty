<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Tlog_in_wuc.ascx.cs" Inherits="log_in_wuc" %>

  <table align="center"  dir="rtl" style="font-family:ae_Arab">
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#3366FF" Text="اسم المستخدم : "></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#6666FF" Text="كلمة السر : "></asp:Label>
                    </td>
                    <td >
