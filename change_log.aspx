 ...
 <table align="center" class="auto-style2" dir="rtl">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="يجب إدخال اسم المستخدم القديم" ForeColor="Red" ControlToValidate="TextBox1">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="يجب إدخال كلمة السر القديمة" ForeColor="Red" ControlToValidate="TextBox2">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="يجب إدخال اسم المستخدم الجديد" ForeColor="Red" ControlToValidate="TextBox3">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="يجب إدخال كلمة السر الجديدة" ForeColor="Red" ControlToValidate="TextBox4">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="يجب تأكيد كلمة السر" ForeColor="Red" ControlToValidate="TextBox5">*</asp:RequiredFieldValidator>
&nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="كلمة السر  الجديدة وتأكيدها التي ادخلتهما غير متطابقتين" ForeColor="Red" ControlToCompare="TextBox4" ControlToValidate="TextBox5">*</asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
